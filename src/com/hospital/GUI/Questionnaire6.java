...
String Question6="";
	...
	public static void main6() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Questionnaire6 window = new Questionnaire6();
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(170, 32, 120, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					RMIInterface RMIInterface = (RMIInterface)Naming.lookup("rmi://localhost:5099/hello");
					String output = RMIInterface.que6(Question6);
					if(rdbtnNewRadioButton.isSelected()){
						ans = rdbtnNewRadioButton.getText();
						
						frame.dispose();
						Questionnaire7 q6 = new Questionnaire7();
						q6.main7();
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame.dispose();
				Questionnaire5 q6 = new Questionnaire5();
				q6.main5();
				frame.setVisible(true);
				frame.dispose();
			}
